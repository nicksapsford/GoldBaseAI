"""
compass/audusd_data.py -- AUDUSD (C:AUDUSD) data layer for the Session-2 baseline backtest.
...
TIMEFRAMES = {"5min": (5, "minute", "audusd_5min.csv"),
              "1hour": (1, "hour", "audusd_1hour.csv"),
              "daily": (1, "day", "audusd_daily.csv")}
BACKFILL_DAYS = 730
