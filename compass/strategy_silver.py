"""
SilverTrader BACKTEST -- strategy_silver.py (compass Session 2)
Silver (C:XAGUSD) mechanics. COPY of strategy_gold with cent-scaled constants (Silver ~$64 vs Gold ~$4375).
Silver "point" = $0.01. Backtest-only; NOT a live system.
...
TRAILING_STOP_POINTS   = 0.40    # trailing stop in gold points ($/oz). GoldBase v1.0.2 (6 Aug 2026):
...
TAKE_PROFIT_POINTS     = 0.25    # Commission 025 exit fix (14 Aug 2026): banks the common move before the trail gives it back    # scalp target. GoldBase v1.0.2: raised 50->90 (Commission 019) -- the
...
TIGHT_TRAIL_ACTIVATE_POINTS = 0.30   # profit (pt) at which the trail tightens 40 -> 10
TIGHT_TRAIL_POINTS          = 0.10   # tight trailing distance (pt) after activation
...
SPREAD_POINTS          = 0.02    # Capital.com gold spread (very low cost)
