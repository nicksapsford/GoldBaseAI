"""
compass/silver_data.py -- Silver (C:XAGUSD) data layer for the Session-2 baseline backtest.
...
TIMEFRAMES = {"5min": (5, "minute", "silver_5min.csv"),
              "1hour": (1, "hour", "silver_1hour.csv"),
              "daily": (1, "day", "silver_daily.csv")}
BACKFILL_DAYS = 730
