"""
compass/gbpusd_data.py -- GBPUSD (C:GBPUSD) data layer for the Session-2 baseline backtest.
...
TIMEFRAMES = {"5min": (5, "minute", "gbpusd_5min.csv"),
              "1hour": (1, "hour", "gbpusd_1hour.csv"),
              "daily": (1, "day", "gbpusd_daily.csv")}
BACKFILL_DAYS = 730
